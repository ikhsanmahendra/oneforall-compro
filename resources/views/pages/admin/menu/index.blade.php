...
@section('content')
  <x-container-admin-page>
    <x-slot:content>
      <x-title-admin-page title="Menu Management" />

      <div class="w-full h-full flex justify-end">
        <a href="/menus/create" class="hidden md:block lg:block w-fit h-fit px-5 py-2 bg-red-500 text-xs rounded-lg text-white">Tambah Data</a>
        <a href="/menus/create" class="block md:hidden lg:hidden w-fit h-fit px-5 py-3 bg-red-500 text-xs rounded-lg text-white">
